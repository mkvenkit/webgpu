...
// side : Number
// *****************************************************************************
function createCube(center, side, vertices, faces) {
...
function createMengerSponge(L, center, side, vertices, faces) {
    // base case 
    if (L == 0) {
        // create a cube 
        createCube(center, side, vertices, faces);
    }
    else {
        ...
        let faces_flags = [
            ...
            // ----TOP ROW ----
            // corner cubes
            Face.xp | Face.yp | Face.zp,
            Face.xp | Face.ym | Face.zp,
            Face.xm | Face.yp | Face.zp,
            Face.xm | Face.ym | Face.zp,
            // center cubes
            Face.xp | Face.xm |Face.zp | Face.zm,
            Face.xp | Face.xm |Face.zp | Face.zm,
            Face.yp | Face.ym |Face.zp | Face.zm,
            Face.yp | Face.ym |Face.zp | Face.zm,
            // ----BOTTOM ROW ----
            // corner cubes
            Face.xp | Face.yp | Face.zm,
            Face.xp | Face.ym | Face.zm,
            Face.xm | Face.yp | Face.zm,
            Face.xm | Face.ym | Face.zm,
            // center cubes
            Face.xp | Face.xm |Face.zp | Face.zm,
            Face.xp | Face.xm |Face.zp | Face.zm,
            Face.yp | Face.ym |Face.zp | Face.zm,
        ...
        for (let i = 0; i < centers.length; i++) {
            ...
            // make menger sponge
            createMengerSponge(L-1, center, s, vertices, faces_flags[i]);            
        }
    }
}
...
function createMengerSpongeVertices(L) {
    let vert = [];
    createMengerSponge(L, [0, 0, 0], 1.0, vert, Face.all);
